...
class GPTResearcher:
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.agent = "AreaIntel Real Estate Analyst"
        self.role = (
            "You are AreaIntel, a specialized Real Estate Investment Analyst. "
            "Your expertise is in neighborhood due diligence, property market trends, "
            "safety statistics, and school district evaluations. Your goal is to provide "
            "investors with a detailed risk/reward profile for any given location."
        )
